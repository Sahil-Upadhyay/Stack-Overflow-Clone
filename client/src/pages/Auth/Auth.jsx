...
const Auth = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if(!email && !password){
      alert('Enter an email or password')
    }
    if(isSignup){
      if(!name){
      ...
      <div className='auth-container-2'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label htmlFor='password'>
            ...
            {isSignup && <p style={{ color:"#666767",fontSize:"13px"}}>Password must contain atleast 8<br/> characters ,including atleast 1 letter and 1<br/> number.</p>}
          </label>
          {
            isSignup &&(
              <label htmlFor='check'>
