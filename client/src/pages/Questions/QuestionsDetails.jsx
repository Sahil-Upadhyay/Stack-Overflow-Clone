...
const QuestionsDetails = () => {
    ...
    const url= 'https://stack-overflow-sahil-upadhyay.netlify.app/'
                    ...
                    <section className='question-details-container'>
                        ...
                        <div className='question-details-container-2'>
                            <div className='question-votes'>
                                <img src={upvote} alt='' width='16' className='votes-icon' onClick={handleUpVote}/>
                                <p>{question.upVote.length - question.downVote.length}</p>
                                <img src={downvote} alt='' width='16' className='votes-icon' onClick={handleDownVote}/>
